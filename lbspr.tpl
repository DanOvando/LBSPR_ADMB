...
PROCEDURE_SECTION
 ...
 obj_fun = -sum(elem_prod(ObsLength, log(elem_div(PredLenComp+0.00000001,ObsLength+0.00000001)))); // AP font ADMB living doc
 
 // obj_fun = -sum(elem_prod(ObsLength, log(PredLenComp)));
